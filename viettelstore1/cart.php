    ...
    <table class="table table-hover">
        ...
        ?>
                            <tr>
                                ...
                                <td><img width="40px" class="thumnail" src="../viettelstore1/images/img/chung/<?php echo $sp["hinhanh"]; ?>" alt=""> </td>
        ...
        <table class="table table-hove">
            ...
            <?php foreach ($giohang as $id => $sp) :
                ...
                <tr>
                    ...
                    <td><img width="50" src="../viettelstore1/images/img/chung/<?php echo $sp["hinhanh"]; ?>" alt=""> </td>
                    <td><?php echo $sp["tensanpham"]; ?></td>
