	...
	<div class="col-sm-9">
		<div class="row">
			<div class="col-md-6">
				...
				<div><img style="border-radius: 20px" width="500px" src="../viettelstore1/images/img/chung/<?php echo $mhct["hinhanh"]; ?>"></div>
			</div>
					...
					<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-5">
						<div class="card h-100 shadow">
							...
							<span class="icon-cross">
								<img src="../viettelstore1/images/img/chung/<?php echo $sp["hinhanh"]; ?>" class="img-fluid">
							</span>
												...
												<div class="rounded-3 w-100 p-7 p-lg-10 mb-10 mt-2">
													<div class="d-flex align-items-center mt-2 ml-2">
														...
														<div class="symbol symbol-35px me-3" style="padding-left: 10px;">
															<img class="rounded-circle shadow-1-strong me-3" width="40px" height="40px" src="../viettelstore1/icon.png" alt="">
														</div>
														<!--end::Author-->
